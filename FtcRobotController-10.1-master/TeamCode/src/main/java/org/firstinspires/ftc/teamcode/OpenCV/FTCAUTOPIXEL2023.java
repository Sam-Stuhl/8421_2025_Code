...
@Autonomous(name = "FTCAUTOPIXEL2023", group = "Autonomous")
public class FTCAUTOPIXEL2023 extends LinearOpMode {
    ...
    private RedObjectPositionPipeline redObjectPipeline;
    ...
    public void runOpMode() {
        ...
        redObjectPipeline = new RedObjectPositionPipeline();
        ...
        while (opModeIsActive()) {
            ...
            switch (redObjectPipeline.getObjectPosition()) {
                case CENTER:
                    // Move the robot left
                    moveCenter();
            ...
            telemetry.addData("Object Position", redObjectPipeline.getObjectPosition());
            telemetry.update();
        }
    ...
    public static class RedObjectPositionPipeline extends OpenCvPipeline {
        ...
        public RedObjectPositionPipeline() {
            hsvImage = new Mat();
            mask = new Mat();
            hierarchy = new Mat();
        }
        ...
        public Mat processFrame(Mat input) {
            ...
            Imgproc.cvtColor(input, hsvImage, Imgproc.COLOR_RGB2HSV_FULL);
