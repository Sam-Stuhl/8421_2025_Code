...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx lFront = hardwareMap.get(DcMotorEx.class, "lFront");
        DcMotorEx lBack = hardwareMap.get(DcMotorEx.class, "lBack");
        DcMotorEx rBack = hardwareMap.get(DcMotorEx.class, "rBack");
        DcMotorEx rFront = hardwareMap.get(DcMotorEx.class, "rFront");
        ...
        leftMotors = Arrays.asList(lFront, lBack);
        rightMotors = Arrays.asList(rFront, rBack);
