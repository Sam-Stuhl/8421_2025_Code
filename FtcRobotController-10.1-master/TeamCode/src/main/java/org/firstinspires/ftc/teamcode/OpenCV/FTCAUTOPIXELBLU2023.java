...
@Autonomous(name = "FTCAUTOPIXELBLU2023", group = "Autonomous")
public class FTCAUTOPIXELBLU2023 extends LinearOpMode {
    ...
    private void moveCenter() {
        ...
        bucketarm.setPosition(0.50);
        bucket.setPosition(0.34); //was .7
        runtime.reset();
        while (opModeIsActive() && (runtime.seconds() < 1.0)) {
            telemetry.addData("Path", "Leg 1: %4.1f S Elapsed", runtime.seconds());
            telemetry.update();
