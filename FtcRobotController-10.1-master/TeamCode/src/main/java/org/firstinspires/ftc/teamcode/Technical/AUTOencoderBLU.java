package org.firstinspires.ftc.teamcode.Technical;
...
@Disabled
public class AUTOencoderBLU extends LinearOpMode {
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            newLeftBTarget = lFront.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newRightBTarget = rFront.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH);
            newLeftFTarget =  lBack.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newRightFTarget = rBack.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH);

            lFront.setTargetPosition(newLeftFTarget);
            rFront.setTargetPosition(newRightFTarget);
            lBack.setTargetPosition(newLeftBTarget);
            rBack.setTargetPosition(newRightBTarget);
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Running to",  " %7d :%7d",newLeftFTarget, newLeftBTarget,
                                                                   newRightFTarget, newRightBTarget);
                telemetry.addData("Currently at",  " at %7d :%7d",
                        lFront.getCurrentPosition(), rFront.getCurrentPosition(),
                        lBack.getCurrentPosition(), rBack.getCurrentPosition());
                telemetry.update();
            }
